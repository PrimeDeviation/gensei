...
export function showHelperAnimation(configPoint) {
    // Your code to show helper animation here
}

export function hideHelperAnimation() {
    // Your code to hide helper animation here
}